    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <main>
        <section className="mb-10 p-6 bg-blue-50 rounded-lg">
          <h2 className="text-2xl font-semibold mb-4">{t("word.welcome")}</h2>
          <p className="mb-4">{t("word.description")}</p>
          <p>
            {t("word.instruction") ||
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold mb-4">
            {t("word.features.title") || "주요 기능"}
          </h2>
          <ul className="list-disc pl-6 space-y-2">
            <li>{t("word.features.item1") || "OpenAI API를 통한 자동 번역"}</li>
            <li>
              {t("word.features.item2") || "다중 언어 지원 (30개 이상의 언어)"}
            </li>
            <li>
              {t("word.features.item3") ||
                "중첩된 키 경로로 구조화된 번역 관리"}
            </li>
            <li>
              {t("word.features.item4") || "JSON 형식의 간편한 로컬 저장소"}
            </li>
          </ul>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="flex flex-col space-y-4">
            ...
            >
              {t("word.started.admin") || "번역 관리 페이지"}
            </Link>
          </div>
        </section>
      </main>
